...
model.fit(encode_X_train,encode_y_train, epochs=5, verbose=0, callbacks=callbacks)
...
ssa = OptimizerSSA(model=model_p, loss= LOSS,optimiser = OPTIMISER ,max_tokens = 600)  
